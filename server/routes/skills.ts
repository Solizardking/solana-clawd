...
const SOLANA_CLAWD_ARENA_URL = `${SOLANA_CLAWD_REPO}/tree/${SOLANA_CLAWD_BRANCH}/arena`;
const ARENA_INSTALL_URL = `https://raw.githubusercontent.com/Solizardking/solana-clawd/${SOLANA_CLAWD_BRANCH}/arena/install.sh`;
