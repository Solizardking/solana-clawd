...
def action_plan(
    ...
    *,
    ...
    plan: dict[str, Any] = {
        ...
        "profile": profile,
        "sandbox": {
            "image": sandbox_cfg.get("image", "openclawd"),
            "name": sandbox_cfg.get("name", "openclawd"),
...
def action_apply(
    ...
    sandbox_name: str = sandbox_cfg.get("name", "openclawd")
    sandbox_image: str = sandbox_cfg.get("image", "openclawd")
...
def action_rollback(rid: str) -> None:
    ...
    if plan_file.exists():
        ...
        sandbox_name = plan.get("sandbox_name", "openclawd")
