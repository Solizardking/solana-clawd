...
for f in Dockerfile nemoclawd/dist nemoclawd/openclawd.plugin.json scripts/nemoclawd-start.sh; do
...
echo ""
echo "    openclawd config set gateway.mode remote"
echo "    openclawd config set gateway.remote.url wss://${APP_NAME}.fly.dev"
echo "    openclawd config set gateway.remote.token ${GATEWAY_TOKEN}"
echo "    openclawd health"
echo ""
