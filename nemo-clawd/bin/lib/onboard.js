...
async function createSandbox(gpu) {
  ...
  const basePolicyPath = path.join(ROOT, "nemoclawd-blueprint", "policies", "openclawd-sandbox.yaml");
  const createArgs = [
...
async function setupOpenclawd(sandboxName) {
...
async function onboard() {
  ...
  await setupOpenclawd(sandboxName);
