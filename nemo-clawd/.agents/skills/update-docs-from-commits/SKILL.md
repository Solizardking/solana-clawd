...
2. **Files changed**: Changes to `nemoclawd/src/`, `nemoclawd-blueprint/`, `bin/`, `scripts/`, or policy-related code are high-signal.
...
|---|---|
| `nemoclawd/src/commands/` (launch, connect, status, logs) | `docs/reference/commands.md` |
| `nemoclawd/src/commands/` (new command) | May need a new page or entry in `docs/reference/commands.md` |
| `nemoclawd/src/blueprint/` | `docs/about/architecture.md` |
| `nemoclawd/src/cli.ts` or `nemoclawd/src/index.ts` | `docs/reference/commands.md`, `docs/get-started/quickstart.md` |
| `nemoclawd-blueprint/orchestrator/` | `docs/about/architecture.md` |
| `nemoclawd-blueprint/policies/` | `docs/reference/network-policies.md` |
| `nemoclawd-blueprint/blueprint.yaml` | `docs/about/architecture.md`, `docs/reference/inference-profiles.md` |
...
- **Always capitalize NemoClaw correctly.** Wrong: nemoclawd (in prose), Nemoclawd.
