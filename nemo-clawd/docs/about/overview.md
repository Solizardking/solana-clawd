...
keywords: ["nemoclawd overview", "openclawd openshell sandbox plugin"]
topics: ["generative_ai", "ai_agents"]
tags: ["openclawd", "openshell", "sandboxing", "inference_routing", "blueprints"]
content:
  type: concept
...
NemoClaw is the [OpenClaw](https://openclawd.ai) plugin for [NVIDIA OpenShell](https://github.com/NVIDIA/OpenShell).
