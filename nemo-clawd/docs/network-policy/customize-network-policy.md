...
tags: ["openclawd", "openshell", "network_policy", "security", "nemoclawd"]
content:
  type: how_to
...
Open `nemoclawd-blueprint/policies/openclawd-sandbox.yaml` and add or modify endpoint entries.
...
Follow the same format as the baseline policy in `nemoclawd-blueprint/policies/openclawd-sandbox.yaml`.
