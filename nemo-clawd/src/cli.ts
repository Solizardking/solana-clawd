...
/**
 * CLI registrar for `openclawd nemoclawd <subcommand>`.
 *
...
export function registerCliCommands(ctx: PluginCliContext, api: OpenClawPluginApi): void {
  ...
  const nemoclawd = program.command("nemoclawd").description("NemoClaw sandbox management");
