...
install_motd() {
  ...
  local INSTALLED_CLOUD_OS="$HOME/src/solana-clawd/clawd-cloud-os"
...
export CLAWD_CLOUD_OS_HOME="${INSTALLED_CLOUD_OS}"

# Shortcuts
alias clawd-cli='${INSTALLED_CLOUD_OS}/tools/clawd-cli.sh'
alias clawd-help='cat ${INSTALLED_CLOUD_OS}/docs/terminal-help.md 2>/dev/null || echo "Run bootstrap first"'
alias clawd-start='${INSTALLED_CLOUD_OS}/tools/clawd-cli.sh start'
alias clawd-stop='${INSTALLED_CLOUD_OS}/tools/clawd-cli.sh stop'
alias clawd-status='${INSTALLED_CLOUD_OS}/tools/clawd-cli.sh status'
alias clawd-doctor='${INSTALLED_CLOUD_OS}/tools/clawd-cli.sh doctor'
alias clawd-logs='${INSTALLED_CLOUD_OS}/tools/clawd-cli.sh logs'
