# ABOUTME: Core orchestration loop implementing the Llobster Legend operator loop
# ABOUTME: Manages AI agent execution with safety, metrics, and recovery

"""Core orchestration loop for OpenClawd Operator."""
...
class RalphOrchestrator:
    ...
    def __init__(
        ...
        logger.info(f"OpenClawd Operator initialized with {primary_tool}")
    ...
    async def arun(self) -> None:
        ...
        logger.info("Starting OpenClawd Operator orchestration loop")
    ...
    async def _create_checkpoint(self):
        ...
        try:
            ...
            # Commit
            proc = await asyncio.create_subprocess_exec(
                "git", "commit", "-m", f"OpenClawd Operator checkpoint {self.metrics.iterations}",
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE
            )
            _, stderr = await proc.communicate()
    ...
    def _print_summary(self):
        ...
        self.console.print_header("OpenClawd Operator Orchestration Summary")
