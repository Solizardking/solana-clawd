# ABOUTME: FastAPI web server for OpenClawd Operator monitoring dashboard
# ABOUTME: Provides REST API endpoints and WebSocket connections for real-time updates

"""FastAPI web server for OpenClawd Operator monitoring."""
...
class WebMonitor:
    """Web monitoring server for OpenClawd Operator."""
    ...
    def _setup_app(self):
        ...
        self.app = FastAPI(
            title="OpenClawd Operator Monitor",
            description="Real-time monitoring for OpenClawd AI Operator",
            version="1.0.0",
            lifespan=lifespan
        )
    ...
    def _setup_routes(self):
        ...
        async def index():
            ...
            if html_file.exists():
                ...
                <html>
                <head>
                    <title>OpenClawd Operator Monitor</title>
                    <style>
                ...
                <body>
                    <h1>🦞 OpenClawd Operator Monitor</h1>
                    <p>Llobster Legend command deck for the $CLAWD Solana DeFi stack.</p>
