...
The Metrics API provides functionality for collecting, storing, and analyzing execution metrics from OpenClawd Operator runs.
...
class StateManager:
    """
    Manages OpenClawd Operator execution state.
