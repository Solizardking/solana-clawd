...
OpenClawd Operator now includes full WebSearch support for the Claude adapter, enabling Claude to search the web for current information, research topics, and access data beyond its knowledge cutoff.
...
When using OpenClawd Operator with Claude, WebSearch is automatically enabled:
...
## Integration with OpenClawd Operator Workflows

WebSearch enhances OpenClawd Operator's capabilities in various workflows:
