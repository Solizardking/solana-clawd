# ABOUTME: Error formatter for OpenClawd Operator
# ABOUTME: Provides structured error messages with user-friendly suggestions

"""
Error formatter for OpenClawd Operator.
...
class ClaudeErrorFormatter:
    ...
    def format_interrupted_error(iteration: int) -> ErrorMessage:
        ...
        return ErrorMessage(
            ...
            suggestion="This usually happens when stopping OpenClawd Operator - no action needed"
        )
