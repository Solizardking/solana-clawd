...
test -f "$repo/main/Kconfig.projbuild"
test -f "$repo/main/idf_component.yml"
...
cp "$overlay_dir/orelane_led.c" "$repo/main/orelane_led.c"
cp "$overlay_dir/orelane_led.h" "$repo/main/orelane_led.h"
