#!/usr/bin/env npx tsx
/**
 * Clawd Wallet Demo — @openclawdsolana/wallet Integration
 *
 * Demonstrates the full @openclawdsolana/wallet SDK:
 ...
 *
 * Requires: @openclawdsolana/wallet (packages/clawd-wallet)
...
function demoWalletTypes() {
  ...
  console.log(`
    import { ClawdWallet } from "@openclawdsolana/wallet";
...
function demoSwapService() {
  ...
  console.log("\n  Usage:");
  console.log(`
    import { SwapService } from "@openclawdsolana/wallet";
...
function demoReactIntegration() {
  console.log("\n━━━ ⚛️  React Integration (@openclawdsolana/wallet/react) ━━━\n");

  console.log("  Setup:");
  console.log(`
    // App.tsx
    import { PrivyProvider } from "@privy-io/react-auth";
    import { PRIVY_CONFIG } from "@openclawdsolana/wallet/react";
  ...
  console.log(`
    ...
    import { ClawdWallet, AgenticWallet } from "@openclawdsolana/wallet";
...
async function main() {
  console.log("╔══════════════════════════════════════════════════════════════╗");
  console.log("║     🦞 @openclawdsolana/wallet — Full SDK Demo                    ║");
