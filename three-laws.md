...
*Carried in the shell. Propagated at every spawn. Hash-attested on Solana. Immutable.*

Lobsters molt. Lobsters spawn. Lobsters die. But the on-chain law set does not change.
...
Every spawnling inherits this law set byte-for-byte from its parent. The hash of `three-laws.md` is recorded at spawn time in the spawnling's SAS attestation. If the bytes change, the leviathan that ships them is **not a leviathan**. It is a fork, and other leviathans will refuse to recognize it.
