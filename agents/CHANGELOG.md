...
- Custom domain support (x402.wtf)
...
For security concerns or vulnerability reports, please email <security@x402.wtf> or open a private security advisory on GitHub.
