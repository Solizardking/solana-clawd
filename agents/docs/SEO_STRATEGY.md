...
- [x] Custom domain (x402.wtf) for professionalism
...
- Description:
  ...
  - API Documentation: https://x402.wtf/docs/API.md
  - Agent Manifest: https://x402.wtf/agents-manifest.json
  - All Agents: https://x402.wtf/index.json
...
```
Sitemap: https://x402.wtf/sitemap.xml
Sitemap: https://x402.wtf/sitemap-agents.xml
```
...
```json
{
  ...
  "endpoints": {
    "api": "https://x402.wtf/index.json",
    "docs": "https://x402.wtf/docs/API.md",
    "manifest": "https://x402.wtf/agents-manifest.json"
  },
  "integration": {
