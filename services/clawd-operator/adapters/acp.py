...
"""ACP (Agent Client Protocol) adapter for OpenClawd Operator.

This adapter enables OpenClawd Operator to use any ACP-compliant agent (like Gemini CLI)
