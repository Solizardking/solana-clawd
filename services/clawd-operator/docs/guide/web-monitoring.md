...
The OpenClawd Operator includes a powerful web-based monitoring dashboard that provides real-time visibility into agent execution, task progress, and system health metrics. This guide covers everything you need to know about setting up, running, and using the web monitoring interface.
...
The web monitoring dashboard is included with the OpenClawd Operator installation. Ensure you have:

```bash
# OpenClawd Operator installed
...
```ini
[Unit]
Description=OpenClawd Operator Web Monitor
