...
Effective prompt engineering is crucial for successful OpenClawd Operator tasks. This guide covers best practices, patterns, and techniques for writing prompts that get results.

## Prompt File Basics

### File Format

OpenClawd Operator uses Markdown files for prompts:
...
OpenClawd Operator modifies the prompt file during execution. Design prompts that support iteration:
...
OpenClawd Operator automatically sanitizes prompts for:
