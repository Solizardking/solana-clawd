...
All notable changes to OpenClawd Operator will be documented in this file.
...
Thanks to all contributors who have helped improve OpenClawd Operator:

- Geoffrey Huntley (@ghuntley) - Original Llobster Legend operator loop
