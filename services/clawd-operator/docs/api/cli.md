...
The CLI API provides the command-line interface for OpenClawd Operator, including commands, arguments, and shell integration.
...
class RalphCLI:
    """
    Main CLI interface for OpenClawd Operator.
    ...
    def create_parser(self) -> argparse.ArgumentParser:
        ...
        parser = argparse.ArgumentParser(
            prog='ralph',
            description='OpenClawd Operator - AI task automation',
...
def cmd_init(self, args, config):
    """
    Initialize new OpenClawd Operator project.
    ...
    """
    print("Initializing OpenClawd Operator project...")
...
def cmd_status(self, args, config):
    """
    Show current OpenClawd Operator status.
    ...
    """
    print("OpenClawd Operator Status")
    print("=" * 40)
...
def cmd_clean(self, args, config):
    ...
    """
    print("Cleaning OpenClawd Operator workspace...")
    
    # Confirm before cleaning
    response = input("This will remove all OpenClawd Operator data. Continue? [y/N]: ")
    if response.lower() != 'y':
        print("Cancelled")
        return 0
...
class InteractiveCLI:
    """
    Interactive CLI mode for OpenClawd Operator.
    ...
    def run(self):
        ...
        print("OpenClawd Operator Interactive Mode")
