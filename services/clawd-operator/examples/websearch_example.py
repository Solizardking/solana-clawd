#!/usr/bin/env python3
# ABOUTME: Example demonstrating WebSearch capability with OpenClawd Operator's Claude adapter
# ABOUTME: Shows how to use Claude's WebSearch tool for current information

"""Example: Using WebSearch with OpenClawd Operator and Claude."""
...
def example_websearch_task():
    ...
    print("\n=== WebSearch Example with OpenClawd Operator ===\n")
...
def main():
    ...
    print("\n" + "="*60)
    print(" WebSearch Examples for OpenClawd Operator")
    print("="*60)
    ...
    print("\nWebSearch is now available in OpenClawd Operator!")
