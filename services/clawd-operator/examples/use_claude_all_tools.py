#!/usr/bin/env python3
# ABOUTME: Example of using OpenClawd Operator with Claude's full native tool access
# ABOUTME: Shows how to configure the adapter to enable all available tools

"""Example: Using OpenClawd Operator with Claude's full native tool capabilities."""
...
def example_orchestrator_with_claude_tools():
    """Example of using OpenClawd Operator with Claude's tools."""
    
    print("\n=== OpenClawd Operator with Claude All Tools ===\n")
