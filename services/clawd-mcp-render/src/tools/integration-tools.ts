    ...
    [
      {
        ...
        description: "[Integration] Verify MCP visibility into MCP packages, agent-kit, gateway, sdk, x402, agents, Leviathan, Deep Clawd, packages/*, and service packages",
      ...
      async () => {
        ...
        return {
          ...
          env: {
            ...
            MASSIVE_API_KEY: Boolean(process.env.MASSIVE_API_KEY),
